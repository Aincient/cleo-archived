...
from cms.models import FooterText, CookieTextEN, CookieTextNL
...
@register.inclusion_tag('cms/base/includes/footer_text.html', takes_context=True)
...
@register.inclusion_tag('cms/base/includes/cookie_text_nl.html', takes_context=True)
def get_cookie_text_nl(context):
    cookie_text_nl = ""
    if CookieTextNL.objects.first() is not None:
        cookie_text_nl = CookieTextNL.objects.first().body

    return {
        'cookie_text_nl': cookie_text_nl,
    }

@register.inclusion_tag('cms/base/includes/cookie_text_en.html', takes_context=True)
def get_cookie_text_en(context):
    cookie_text_en = ""
    if CookieTextEN.objects.first() is not None:
        cookie_text_en = CookieTextEN.objects.first().body

    return {
        'cookie_text_en': cookie_text_en,
    }