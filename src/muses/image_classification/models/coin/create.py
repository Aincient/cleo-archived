...
coin_path = os.path.join(IMAGE_CLASSIFICATION_DIR,
...
def create_model(model_definition):
    ...
    """
    try:
        def_path = os.path.join(coin_path, 'definitions', model_definition)
...
# save created model
save_path = os.path.join(coin_path, 'saves', model_name)
print(save_path)
